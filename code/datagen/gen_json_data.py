...
input_data_dir = "./data/" + datasets[0] + "/text-davinci-003/data_5_25/"  # 待标记的中间结果
output_data_dir = "./data/" + datasets[0] + "/text-davinci-003/tmp.jsonl"
...
class ExampleOut(object):
    ...
    def __init__(self, query_idx=int, example_idx=list[int], label=bool):
        self.query_idx = query_idx
...
def main():
    ...
    for i in range(0, 30):
        examples, avg_bleu = read_example_in(
            input_data_dir + "data_" + format(i) + "_5_25.jsonl", 25
        )
